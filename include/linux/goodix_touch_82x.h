...
#if 1
#define GTDEBUG(fmt, arg...) printk("<--GT82X-DEBUG--> "fmt, ##arg)
#else
#define DEBUG(fmt, arg...)
#endif

#if 1
#define GTNOTICE(fmt, arg...) printk("<--GT82X-NOTICE--> "fmt, ##arg)
#else
#define NOTICE(fmt, arg...)
#endif

#if 1
#define GTWARNING(fmt, arg...) printk("<--GT82X-WARNING--> "fmt, ##arg)
#else
#define WARNING(fmt, arg...)
#endif

#if 1
#define GTDEBUG_MSG(fmt, arg...) printk("<--GT82X msg--> "fmt, ##arg)
#else
#define DEBUG_MSG(fmt, arg...)
#endif

#if 1
#define GTDEBUG_UPDATE(fmt, arg...) printk("<--GT82X update--> "fmt, ##arg)
#else
